function ModalEditarProducto(){
	return(
    <div className="modal fade" id="ModalEditarProducto" tabIndex={-1} aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div className="modal-content">
        ...
        <div className="modal-header justify-content-center">
          <div className="titulomodal "> 
              <h1 className="modal-title" id="exampleModalLabel">EDITAR PRODUCTO</h1>
          </div>
